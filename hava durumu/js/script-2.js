...
] // Data içerisinde Türkiye'deki il, ilçe ve bölgelerin belirli bilgileri bulunmakta.
// Dilediğiniz gibi değerlendirebilir, projeyi geliştirebilirsiniz.


for (var i = 0; i < data.length; i++) {
    let element = document.createElement("option");
    element.value = data[i].il_adi;
    element.text = data[i].il_adi;
