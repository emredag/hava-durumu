...
let shortInfo = document.getElementById("info");

function handleShortDesc() {
  for (var i = 0; i < data.length; i++) {
    if (data[i].il_adi === searchBar.value) {
      shortInfo.innerHTML = "Kısa Bilgi: " + data[i].kisa_bilgi;
    }
  }
}

searchBar.addEventListener("change", handleShortDesc);
